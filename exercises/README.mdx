...
<EpicVideo
	...
	url="https://www.epicai.pro/workshops/mcp-fundamentals-mtezq/intro-i51jf"
/>
...
- The core architecture of MCP: **hosts**, **clients**, and **servers**
  ([see architecture](https://modelcontextprotocol.io/specification/2025-11-25/architecture))
...
<callout-info>
	**Spec version note:** MCP is versioned by specification release. This
	workshop focuses on the stable server fundamentals from the current released
	spec. Newer or optional capabilities like authentication, sampling, tasks, and
	MCP Apps are covered in other workshops or dedicated follow-up material.
</callout-info>
